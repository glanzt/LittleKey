...
const S = {
  ...
  bgGrid: {
    ...
    inset: 0,
    backgroundImage: [
      "linear-gradient(rgba(79,134,198,0.05) 1px, transparent 1px)",
      "linear-gradient(90deg, rgba(79,134,198,0.05) 1px, transparent 1px)",
    ].join(", "),
  ...
  navLogo: {
    ...
    boxShadow: "0 16px 36px rgba(79,134,198,0.16)",
  },
  ...
  heroBadge: {
    ...
    boxShadow: "0 14px 28px rgba(79,134,198,0.18)",
  ...
  title: {
    ...
    textAlign: "center",
    textWrap: "balance",
    textShadow: "0 4px 18px rgba(255,255,255,0.45)",
  },

  subtitle: {
    marginTop: "1rem",
    color: "rgba(46,58,89,0.72)",
